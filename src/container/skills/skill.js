...
import {
  SiJquery, SiTypescript ,SiPhp, SiNextdotjs,  SiRedux, SiExpress, SiPostgresql, SiNodedotjs
} from "react-icons/si";
...
export default function Skill() {
  const skills = [
    ...
    {id: 5, icon:    <SiPhp size={48} color="#8892BF" />, name: "Php"},
    { id: 6, icon:   <SiNextdotjs size={50} className="#fff" color="#fff"/> , name: "Next"},
    { id: 7, icon: <FaReact size={50} title="React" color="#61DBFB" />, name: "React" },
    { id: 8, icon: <SiExpress size={50}title="Express.js" color="#fff" />, name: "Express" },
    { id: 9, icon: <SiPostgresql size={50} title="PostgreSQL" color="#336791" />, name: "PostgreSQL" },
    { id: 10, icon: <FaBootstrap size={50} title="Bootstrap" color="#7952B3" />, name: "Bootstrap" },
    { id: 11, icon: <SiJquery size={50} title="jQuery" color="#0769AD" />, name: "jQuery" },
    { id: 12, icon: <SiRedux size={50} title="Redux" color="#764ABC" />, name: "Redux" },
