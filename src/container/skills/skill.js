...
import {
  SiJquery, SiTypescript , SiNextdotjs,  SiRedux, SiExpress, SiPostgresql, SiNodedotjs
} from "react-icons/si";
...
export default function Skill() {
  const skills = [
    ...
    { id: 5, icon:   <SiNextdotjs size={50} className="#fff" color="#fff"/> , name: "Next"},
    ...
    { id: 12, icon: <FaHtml5 size={50} title="HTML" color="#E34F26" />, name: "HTML" },
    { id: 13, icon: <FaCss3Alt size={50} title="CSS" color="#1572B6" />, name: "CSS" },
    { id: 14, icon: <FiFigma size={50} title="Figma" color="#F24E1E" />, name: "Figma" },
    { id: 15, icon: <FaGitAlt size={50} title="Git" color="#F05033" />, name: "Git" }
